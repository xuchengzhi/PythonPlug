...
# url=["http://video.renrenjiang.cn/record/alilive/4033033000-1513396719.m3u8"]
url=["?"]
riqi1='%Y-%m-%d'
m_time1= time.strftime(riqi1,time.localtime())
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(len(url)):
	        _url=url[i]
	        _path=os.getcwd()+"\\"+"ts"+(str(i)+"_"+str(m_time1))
	        try:
	        	os.chdir(_path)
	        except Exception, e:
	        	os.mkdir(_path)
